    ...
    <div className="container max-w-screen px-22 py-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-6 gap-4">
        ...
        {products.map((product) => (
          <div key={product.id} className="bg-white rounded-3xl p-6 relative flex flex-col justify-between shadow-md transition-all duration-300 hover:shadow-2xl hover:scale-105 ">
        ...
        {/* Featured Product */}
        <div className="bg-gray-200 rounded-3xl p-6 flex flex-col justify-between relative lg:col-span-3 shadow-md transition-all duration-300 hover:shadow-2xl hover:scale-105">
