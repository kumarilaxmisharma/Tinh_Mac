...
//             description: "Powered by Apple's M1 chip, the MacBook Pro delivers blazing fast performance with its 8-core CPU and GPU, ensuring smooth multitasking and power efficiency."
//           },
//           {
//             title: "STUNNING RETINA DISPLAY:",
//             description: "The 13.3-inch Retina display with True Tone technology offers vibrant colors, sharp contrast, and incredible detail, making it perfect for creative professionals and everyday users."
//           },
//           {
//             title: "ALL-DAY BATTERY LIFE:",
//             description: "With up to 20 hours of battery life, the MacBook Pro M1 lets you work, create, and stream without worrying about running out of power."
//           },
//           {
//             title: "ADVANCED COOLING SYSTEM:",
//             description: "Stay productive without overheating – Apple's silent active cooling system ensures sustained peak performance during intensive tasks."
//           },
//           {
//             title: "SECURE & SEAMLESS EXPERIENCE:",
//             description: "The Magic Keyboard, Touch ID, and macOS integration provide a smooth, secure, and intuitive user experience, while Apple's M1 chip enhances privacy protection."
//           }
//         ]
//       };
...
//             <span className="text-gray-500">({product.reviewCount.toLocaleString()} User feedback)</span>
//           </div>
...
//             </div>
//             <div>
//               <span className="text-gray-500">Availability:</span> {product.availability}
//             </div>
//             <div>
...
//             <span className="bg-gray-200 px-2 py-1 text-sm">{product.discount} OFF</span>
//           </div>
...
//                   <div className="w-8 h-8 rounded-full bg-gray-400 border-2 border-black"></div>
...
//               </button>
//               <div className="px-4 py-3">{String(quantity).padStart(2, '0')}</div>
//               <button className="px-4 py-3" onClick={increaseQuantity}>
//                 <Plus className="w-4 h-4" />
//               </button>
//             </div>
            
//             <button className="bg-gray-600 text-white px-8 py-3 rounded-lg flex items-center justify-center gap-2 flex-1">
//               ADD TO CART
...
//             <button className="border border-gray-300 text-gray-800 px-8 py-3 rounded-lg">
//               BUY NOW
//             </button>
//           </div>
...
//           {/* Security Info */}
//           <div className="mb-8">
//             <div className="text-center mb-2">100% Guarantee Safe Checkout</div>
...
//           {/* Product Features */}
//           <div>
//             <h3 className="font-bold mb-4">About Item</h3>
